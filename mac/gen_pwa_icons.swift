// Renders the PWA / home-screen icons: a round orange "watch" (gradient ring
// + clock hands) on a near-black tile, matching the app's dark UI.
...
func render(_ pixels: Int) -> Data? {
    ...
    // 1. Near-black rounded tile. iOS masks its own corners; rounded looks
